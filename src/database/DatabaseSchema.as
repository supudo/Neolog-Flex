package database {
	...
	public class DatabaseSchema {
		...
		public const CREATE_TABLE_WORDS:String = "CREATE TABLE IF NOT EXISTS words (id INTEGER PRIMARY KEY AUTOINCREMENT, wordid NUMERIC, wordletter TEXT, orderpos NUMERIC, nestid NUMERIC, example TEXT, ethimology TEXT, description TEXT, derivatives TEXT, commentcount NUMERIC, addedbyurl TEXT, addedbyemail TEXT, addedby TEXT, addedatdate DATE, addedatdatestamp NUMERIC);";
		...
		public const GET_NESTS_COUNT:String = "SELECT n.*, (SELECT COUNT(wordid) FROM words WHERE nestid = n.nid) AS wordscount FROM nests AS n ORDER BY n.orderpos";
		public const GET_NEST:String = "SELECT * FROM nests WHERE nestid = :nestid";
		...
		public const GET_WORDS_FOR_NEST:String = "SELECT * FROM words WHERE nestid = :nestid ORDER BY orderpos DESC";
		public const GET_WORDS_FOR_LETTER:String = "SELECT * FROM words WHERE wordletter = :wordletter ORDER BY orderpos DESC";
		public const GET_WORDS_COMPLEX:String = "SELECT * FROM words WHERE wordletter = :wordletter AND nestid = :nestid ORDER BY orderpos DESC";
		...
		public const INSERT_NESTS:String = "INSERT INTO nests (nestid, title, orderpos) VALUES (:nestid, :title, :orderpos)";
		...
		public const INSERT_WORDS:String = "INSERT INTO words (wordid, wordletter, orderpos, nestid, example, ethimology, description, derivatives, commentcount, addedbyurl, addedbyemail, addedby, addedatdate, addedatdatestamp) VALUES (:wordid, :wordletter, :orderpos, :nestid, :example, :ethimology, :description, :derivatives, :commentcount, :addedbyurl, :addedbyemail, :addedby, :addedatdate, :addedatdatestamp)";
		...
		public const UPDATE_NESTS:String = "UPDATE nests SET title = :title, orderpos = :orderpos WHERE nestid = :nestid";
